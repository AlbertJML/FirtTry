...
#'! ='
bike %>% filter(season != "spring")%>% select(season)
...
# Create a new season with meteorological definitions
sort(names(bike))
...
# Long to wide: Data in multiple columns e.g. temp1, temp2,...temp12
# Wide to long: data in one column, clasifier in other columns 
# tidyr is the package that allow transformations
